...
Usage:
    from svg_to_pptx.config import Config, CANVAS_FORMATS, DESIGN_COLORS
...
# Package root directory (modules and bundled resources live here)
...
# Repository root directory (only meaningful for an in-tree checkout)
