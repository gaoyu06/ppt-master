...
from svg_to_pptx.compact_svg_coordinates import compact_svg_tree
from svg_to_pptx.console_encoding import configure_utf8_stdio
from svg_to_pptx.native_payloads import (
...
from svg_to_pptx.svg_authoring_contract import (
...
def _load_authoring_summary_manifest(
    ...
    from svg_to_pptx.pptx_workspace import ROUNDTRIP_PAGE_PLAN_PATH
