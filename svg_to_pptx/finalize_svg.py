...
from svg_to_pptx.resource_paths import icon_dir_for_project  # noqa: E402
from svg_to_pptx.svg_finalize.align_embed_images import (
    align_and_embed_images_in_svg,
    count_office_vector_refs_in_svg,
)
from svg_to_pptx.svg_finalize.embed_icons import process_svg_file as embed_icons_in_file
...
def process_flatten_text(
    ...
    try:
        from svg_to_pptx.svg_finalize.flatten_tspan import flatten_text_with_tspans
