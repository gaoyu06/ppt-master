...
from svg_to_pptx.extract_svg_assets import extract_directory
...
from svg_to_pptx.svg_authoring_view import project_svg_batch
from svg_to_pptx.animation_config import (
    validate_animation_config_errors,
    validate_transition_config,
)
from svg_to_pptx.template_import.manifest import (
    count_drawable_shapes,
    extract_placeholders,
    part_display_name,
)
from svg_to_pptx.template_import.native_structure import (
