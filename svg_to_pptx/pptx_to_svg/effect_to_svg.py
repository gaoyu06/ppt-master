...
from svg_to_pptx.pptx_effects import native_effect_metadata, unsupported_effect_metadata
from svg_to_pptx.pptx_shapes.formula import OOXML_COORDINATE_MAX
